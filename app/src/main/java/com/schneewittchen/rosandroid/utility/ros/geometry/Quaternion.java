...
public class Quaternion {
    ...
    public static Quaternion fromQuaternionMessage(geometry_msgs.msg.Quaternion message) {
    ...
    public geometry_msgs.msg.Quaternion toQuaternionMessage(geometry_msgs.msg.Quaternion result) {
        result.setX(x);
        result.setY(y);
        result.setZ(z);
        result.setW(w);
