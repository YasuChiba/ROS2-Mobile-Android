...
public class Transform {
    ...
    public static Transform fromTransformMessage(geometry_msgs.msg.Transform message) {
    ...
    public static Transform fromPoseMessage(geometry_msgs.msg.Pose message) {
    ...
    public geometry_msgs.msg.Transform toTransformMessage(geometry_msgs.msg.Transform result) {
    ...
    public geometry_msgs.msg.Pose toPoseMessage(geometry_msgs.msg.Pose result) {
    ...
    public geometry_msgs.msg.PoseStamped toPoseStampedMessage(GraphName frame, Time stamp,
