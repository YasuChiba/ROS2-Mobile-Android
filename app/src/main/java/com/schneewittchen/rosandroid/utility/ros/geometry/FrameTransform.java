...
public class FrameTransform {
    ...
    public static FrameTransform fromTransformStampedMessage(
        ...
        Time stamp = new Time(transformStamped.getHeader().getStamp());
    ...
    public geometry_msgs.msg.TransformStamped toTransformStampedMessage(
            geometry_msgs.msg.TransformStamped result) {
        Preconditions.checkNotNull(time);
        result.getHeader().setFrameId(target.toString());
        result.getHeader().setStamp(time.toRos2Time());
