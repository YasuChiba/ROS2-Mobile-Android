...
public class Vector3 {
    ...
    public static Vector3 fromVector3Message(geometry_msgs.msg.Vector3 message) {
        return new Vector3(message.getX(), message.getY(), message.getZ());
    }

    public static Vector3 fromPointMessage(geometry_msgs.msg.Point message) {
        return new Vector3(message.getX(), message.getY(), message.getZ());
    }
    ...
    public geometry_msgs.msg.Vector3 toVector3Message(geometry_msgs.msg.Vector3 result) {
        result.setX(x);
        result.setY(y);
        result.setZ(z);
        return result;
    ...
    public geometry_msgs.msg.Point toPointMessage(geometry_msgs.msg.Point result) {
        result.setX(x);
        result.setY(y);
        result.setZ(z);
        return result;
